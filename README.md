...
```mermaid
%%{init: {'theme': 'dark', 'themeVariables': { 'pie1': '#38BDF8', 'pie2': '#818CF8', 'pie3': '#34D399', 'pieOuterStrokeWidth': '0px'}}}%%
pie showData
    title How I Spend My Engineering Cycle
    "🎨 Design & Architecture" : 30
    "⚙️ Build & Implement" : 45
    "🔁 Improve & Refine" : 25
```
...
%%{init: {'theme': 'dark'}}%%
radar-beta
    title Front-End Capability Radar
    axis ui["UI Architecture"], perf["Performance"], access["Accessibility"], collab["Collaboration"], types["Type Safety"], design["Design Systems"]
    curve me["Current Focus"]{88, 78, 82, 95, 84, 90}
    max 100
```
